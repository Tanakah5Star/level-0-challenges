function convertToHoursMinutes(number){
    ...
    //Making use of Ternary operators to control singulars and plurals for hours and minutes.
    if(hours != 0){display += hours +" "+((hours==1)?"hour":"hours")+", ";}
    if(minutes != 0){display += minutes +" "+((minutes==1)?"minute.":"minutes.");}
